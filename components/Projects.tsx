      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        >
          ...
          <motion.p
            ...
            className={`${tc.textSecondary} max-w-md text-sm md:text-right`}
          >
        ...
        <div className="mb-24 relative py-12 px-6 rounded-3xl overflow-hidden">
          ...
          >
            <h4 className={`text-3xl font-bold ${tc.textWhite}`}>Pôle <span className="text-nl-blue">BET</span> <span className={`text-lg ${tc.textMuted} font-normal ml-2 hidden sm:inline-block`}>(Bureau d'Etudes Technique)</span></h4>
            <motion.div
              initial={{ width: 0 }}
              animate={{ width: "100%" }}
        ...
        <div className="relative py-12 px-6 rounded-3xl overflow-hidden">
          ...
          <motion.div
            ...
            className="flex items-center gap-6 mb-10 relative z-10"
          >
            <h4 className={`text-3xl font-bold ${tc.textWhite}`}>Pôle <span className="text-nl-yellow">BEI</span> <span className={`text-lg ${tc.textMuted} font-normal ml-2 hidden sm:inline-block`}>(Bureau d'Etudes Industriel)</span></h4>
            <motion.div
              initial={{ width: 0 }}
